...
mixin _$LoginDto {
  ...
  @override
  String toString() {
    return 'LoginDto(username: $username, password: $password, type: $type)';
  }
}
...
abstract mixin class $LoginDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String username, String password, String type});
}
...
class _LoginDto implements LoginDto {
  _LoginDto({required this.username, required this.password, this.type = "1"});
